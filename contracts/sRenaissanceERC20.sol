...
contract sRenaissance is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Renaissance", "sART", 9) ERC20Permit() {
    ...
    /**
        @notice increases sART supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sART

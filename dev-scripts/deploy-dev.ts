...
async function main() {
  ...
  const governorAddress = deployer.address; // multisig address
  const policyAddress = deployer.address; // multisig address
  const vaultAddress = deployer.address; // temp multisig later replaced with treasury address
  const paletteAddress = deployer.address; // multisig address
